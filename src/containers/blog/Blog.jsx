...
const Blog = () => {
    return (
        <div className="gpt__blog section__padding" id="blod">
            <div className="gpt__blog-heading">
                <h1 className="gradient__text">A lot is happening, We are blogging about it.</h1>
            </div>
            <div className="gpt__blog-conteiner">
                <div className="gpt__blog-conteiner_groupA">
                    <Article imgUrl={blog01}  date="Sep 26, 2021"/>
                </div>
                <div className="gpt__blog-conteiner_groupB">
